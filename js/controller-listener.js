AFRAME.registerComponent('controller-listener', {
  ...
  init: function () {
    ...
    this.leftController.addEventListener("triggerdown", function (event) { self.leftTrigger.queuePress = true; });
    this.leftController.addEventListener("triggerup", function (event) { self.leftTrigger.queueRelease = true; });
    this.leftController.addEventListener('triggerchanged', function (event) { self.leftTrigger.value = event.detail.value; });

    this.leftController.addEventListener("gripdown", function (event) { self.leftGrip.queuePress = true; });
    this.leftController.addEventListener("gripup", function (event) { self.leftGrip.queueRelease = true; });
    this.leftController.addEventListener('gripchanged', function (event) { self.leftGrip.value = event.detail.value; });

    this.leftController.addEventListener("xbuttondown", function (event) { self.buttonX.queuePress = true; });
    this.leftController.addEventListener("xbuttonup", function (event) { self.buttonX.queueRelease = true; });

    this.leftController.addEventListener("ybuttondown", function (event) { self.buttonY.queuePress = true; });
    this.leftController.addEventListener("ybuttonup", function (event) { self.buttonY.queueRelease = true; });
    ...
    this.rightController.addEventListener("triggerdown", function (event) { self.rightTrigger.queuePress = true; });
    this.rightController.addEventListener("triggerup", function (event) { self.rightTrigger.queueRelease = true; });
    this.rightController.addEventListener('triggerchanged', function (event) { self.rightTrigger.value = event.detail.value; });

    this.rightController.addEventListener("gripdown", function (event) { self.rightGrip.queuePress = true; });
    this.rightController.addEventListener("gripup", function (event) { self.rightGrip.queueRelease = true; });
    this.rightController.addEventListener('gripchanged', function (event) { self.rightGrip.value = event.detail.value; });

    this.rightController.addEventListener("abuttondown", function (event) { self.buttonA.queuePress = true; });
    this.rightController.addEventListener("abuttonup", function (event) { self.buttonA.queueRelease = true; });

    this.rightController.addEventListener("bbuttondown", function (event) { self.buttonB.queuePress = true; });
    this.rightController.addEventListener("bbuttonup", function (event) { self.buttonB.queueRelease = true; });
  },
